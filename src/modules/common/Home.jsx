    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <div className="relative w-full h-[70vh] mt-16 overflow-hidden">
        ...
        <div className="absolute bottom-20 w-full text-center text-white px-4">
          ...
          <p className="text-lg md:text-xl font-light drop-shadow-md text-slate-200">
      ...
      <div className="max-w-7xl mx-auto w-full py-20 px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 font-medium text-lg max-w-2xl mx-auto">
            ...
            <Link
              to="/register"
              className="ml-2 px-4 py-2 border border-cyan-500 text-cyan-300 rounded-lg hover:bg-cyan-500 hover:text-white transition duration-300"
            >
              Register as Owner
            </Link>
          </p>
