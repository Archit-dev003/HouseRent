...
const RenterAllProperty = () => {
  ...
  return (
    <div className="overflow-x-auto bg-slate-900/70 backdrop-blur-md border border-slate-700 shadow-xl rounded-xl p-6">
      <h2 className="text-xl font-semibold text-cyan-300 mb-4">
        All My Bookings
      </h2>
      <table className="min-w-full border border-slate-700 text-sm rounded-lg overflow-hidden">
